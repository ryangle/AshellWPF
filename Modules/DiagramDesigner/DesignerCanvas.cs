...
namespace DiagramDesigner
{
    public partial class DesignerCanvas : Canvas
    {
        ...
        {
            var o = Activator.CreateInstance(dragObject.ObjectType);
            //if(o is Path path)
            //{
            //    path.Data = Geometry.Parse("M 9,2 11,7 17,7 12,10 14,15 9,12 4,15 6,10 1,7 7,7 Z");
            //}
        ...
        protected override void OnDrop(DragEventArgs e)
        {
            ...
            if (dragObject != null) // && !String.IsNullOrEmpty(dragObject.Xaml))
            {
                ...
                var content = CreateInstanceFromDragObject(dragObject);
